...
mysql_select_db($database_vmi, $vmi);
$query_rs_report = "select sum((c.qty_order/c.pack_ratio)*c.buy_unit_cost) as sumcost,d.supply_type from stock_withdraw r left outer join stock_withdraw_c c on c.withdraw_no=r.withdraw_no left outer join drugs d on d.working_code=c.working_code  and d.chwpart='".$_SESSION['chwpart']."' and d.amppart='".$_SESSION['amppart']."' left outer join hospcode h on h.hospcode=r.hospcode where 1 ".$condition2." and r.date_withdraw between '".$edate1."' and '".$edate2."' group by d.supply_type";
...
<body>
<form action="stock_report2.php" method="post">
  <div class="thsan-semibold" style="font-size:24px">รายงานสรุปยอดจ่ายยาออกจากคลัง</div>
...
?>
  ...
  <table width="300" border="0" cellspacing="0" cellpadding="5" class="thsan-light table_collapse" >
    <tr class="font_border font20">
      ...
      <td width="357" align="center" bgcolor="#E7E7E7" style=" border-left:1px solid #000; border-bottom:solid 1px #000000">มูลค่าจ่ายยา</td>
      </tr>
    <tr>
