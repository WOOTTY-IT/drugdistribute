...
<body onload="print();">
<div class=" thfont font_border" style="font-size:20px"  align="center">ใบจ่าย<?php echo $row_rs_drug_list['item_type_name']; ?>ประจำเดือน <?php echo monthThai($row_rs_drug_list['month']); ?></div>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0" class=" thfont font16 table_collapse" >
  <tr>
    ...
    <td width="30%" align="left"  class="table_border_black thfont" style="padding-left:10px;">รายการเวชภัณฑ์</td>
    <td width="12%" align="center" class="table_border_black thfont" style="">จำนวนเบิก</td>
    <td width="16%" align="center" class="table_border_black thfont" style="">จำนวนจ่าย</td>
    ...
    <td width="14%" align="center" class="table_border_black thfont" style="">หมายเหตุ</td>
  </tr>
     <?php $i=0; do { $i++; ?>
 <tr>
    ...
    <td align="center" class="table_border_black thfont" style=""><?php echo ($row_rs_drug_list['among']/$row_rs_drug_list['pack_ratio']); ?></td>
      <td align="center" class="table_border_black">&nbsp;</td>
      <td align="center" class="table_border_black thfont" style=""><?php echo $row_rs_drug_list['pack_ratio']; ?></td> 
